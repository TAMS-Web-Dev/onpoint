...
const LOOKING_FOR = ["Ideas that work!", "Fresh looks on old problems", "Problem solvers", "Real-talk"];
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* We're looking for */}
            <p className="mt-6 mb-4 font-semibold text-secondary">We&apos;re looking for:</p>

            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {LOOKING_FOR.map((item) => (
                <li key={item} className="flex items-center gap-3 bg-primary/[0.08] rounded-xl px-4 py-3">
